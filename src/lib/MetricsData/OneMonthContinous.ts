...
const oneMonthContinous = (data: dataType) => {
  const safeData = data || []
  ...
  const startOfWindow = new Date(Date.UTC(currentYear, currentMonth, currentDay - 29, 0, 0, 0))
...
export default oneMonthContinous