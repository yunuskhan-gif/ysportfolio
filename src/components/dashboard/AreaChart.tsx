...
import { ChartAreaDefaultProps } from "./chart.types";
...
export function ChartAreaDefault({
  ...
  return (
    <Card className="h-[150px] max-sm:h-[135px] max-sm:min-w-[240px] max-sm:flex-shrink-0 !p-0 !gap-0 flex flex-col overflow-hidden snap-start shadow-none border">
            ...
            <ChartTooltip
              ...
              content={
                <ChartTooltipContent
                  ...
                  formatter={(value: any) => {
                    if (flag === 1) return [`${value}%`, chartTitle];
                    return [formatCurrency(value), chartTitle];
                  }}
                />
              }
            />
